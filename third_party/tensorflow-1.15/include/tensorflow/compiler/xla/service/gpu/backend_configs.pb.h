...
namespace xla {
namespace gpu {
class CudnnBatchNormBackendConfig;
class CudnnBatchNormBackendConfigDefaultTypeInternal;
extern CudnnBatchNormBackendConfigDefaultTypeInternal _CudnnBatchNormBackendConfig_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::xla::gpu::CudnnBatchNormBackendConfig* Arena::CreateMaybeMessage<::xla::gpu::CudnnBatchNormBackendConfig>(Arena*);
...
class CudnnBatchNormBackendConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.gpu.CudnnBatchNormBackendConfig) */ {
 public:
  CudnnBatchNormBackendConfig();
  virtual ~CudnnBatchNormBackendConfig();

  CudnnBatchNormBackendConfig(const CudnnBatchNormBackendConfig& from);
  CudnnBatchNormBackendConfig(CudnnBatchNormBackendConfig&& from) noexcept
    : CudnnBatchNormBackendConfig() {
    *this = ::std::move(from);
  }

  inline CudnnBatchNormBackendConfig& operator=(const CudnnBatchNormBackendConfig& from) {
    CopyFrom(from);
    return *this;
  }
  inline CudnnBatchNormBackendConfig& operator=(CudnnBatchNormBackendConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CudnnBatchNormBackendConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CudnnBatchNormBackendConfig* internal_default_instance() {
    return reinterpret_cast<const CudnnBatchNormBackendConfig*>(
               &_CudnnBatchNormBackendConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  void Swap(CudnnBatchNormBackendConfig* other);
  friend void swap(CudnnBatchNormBackendConfig& a, CudnnBatchNormBackendConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline CudnnBatchNormBackendConfig* New() const final {
    return CreateMaybeMessage<CudnnBatchNormBackendConfig>(nullptr);
  }

  CudnnBatchNormBackendConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CudnnBatchNormBackendConfig>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CudnnBatchNormBackendConfig& from);
  void MergeFrom(const CudnnBatchNormBackendConfig& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CudnnBatchNormBackendConfig* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.gpu.CudnnBatchNormBackendConfig";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  void clear_activation_mode();
  static const int kActivationModeFieldNumber = 1;
  ::PROTOBUF_NAMESPACE_ID::int64 activation_mode() const;
  void set_activation_mode(::PROTOBUF_NAMESPACE_ID::int64 value);

  // @@protoc_insertion_point(class_scope:xla.gpu.CudnnBatchNormBackendConfig)
 private:
  class HasBitSetters;
...
// int64 activation_mode = 1;
inline void CudnnBatchNormBackendConfig::clear_activation_mode() {
  activation_mode_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CudnnBatchNormBackendConfig::activation_mode() const {
  // @@protoc_insertion_point(field_get:xla.gpu.CudnnBatchNormBackendConfig.activation_mode)
  return activation_mode_;
}
inline void CudnnBatchNormBackendConfig::set_activation_mode(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  activation_mode_ = value;
  // @@protoc_insertion_point(field_set:xla.gpu.CudnnBatchNormBackendConfig.activation_mode)
}
