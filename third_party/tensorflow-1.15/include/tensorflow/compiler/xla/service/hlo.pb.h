...
enum HloInputOutputAliasProto_Kind : int {
  ...
  HloInputOutputAliasProto_Kind_HloInputOutputAliasProto_Kind_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  HloInputOutputAliasProto_Kind_HloInputOutputAliasProto_Kind_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool HloInputOutputAliasProto_Kind_IsValid(int value);
constexpr HloInputOutputAliasProto_Kind HloInputOutputAliasProto_Kind_Kind_MIN = HloInputOutputAliasProto_Kind_UNDEFINED_ALIAS;
constexpr HloInputOutputAliasProto_Kind HloInputOutputAliasProto_Kind_Kind_MAX = HloInputOutputAliasProto_Kind_SYSTEM_ALIAS;
constexpr int HloInputOutputAliasProto_Kind_Kind_ARRAYSIZE = HloInputOutputAliasProto_Kind_Kind_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* HloInputOutputAliasProto_Kind_descriptor();
template<typename T>
inline const std::string& HloInputOutputAliasProto_Kind_Name(T enum_t_value) {
  static_assert(::std::is_same<T, HloInputOutputAliasProto_Kind>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function HloInputOutputAliasProto_Kind_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    HloInputOutputAliasProto_Kind_descriptor(), enum_t_value);
}
inline bool HloInputOutputAliasProto_Kind_Parse(
    const std::string& name, HloInputOutputAliasProto_Kind* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<HloInputOutputAliasProto_Kind>(
...
class HloInstructionProto :
 ...
 public:
  ...
  // string rendezvous_key = 1000;
  void clear_rendezvous_key();
  static const int kRendezvousKeyFieldNumber = 1000;
  ...
  // .xla.ShapeProto async_out_send_shape = 1001;
  bool has_async_out_send_shape() const;
  void clear_async_out_send_shape();
  static const int kAsyncOutSendShapeFieldNumber = 1001;
  const ::xla::ShapeProto& async_out_send_shape() const;
  ::xla::ShapeProto* release_async_out_send_shape();
  ::xla::ShapeProto* mutable_async_out_send_shape();
  void set_allocated_async_out_send_shape(::xla::ShapeProto* async_out_send_shape);
  void unsafe_arena_set_allocated_async_out_send_shape(
      ::xla::ShapeProto* async_out_send_shape);
  ::xla::ShapeProto* unsafe_arena_release_async_out_send_shape();
  ...
  PROTOBUF_DEPRECATED static const int kAllReduceIdFieldNumber = 45;
  ...
  // bool log = 1002;
  void clear_log();
  static const int kLogFieldNumber = 1002;
  bool log() const;
  ...
  // bool is_activation_relu = 73;
  void clear_is_activation_relu();
  static const int kIsActivationReluFieldNumber = 73;
  bool is_activation_relu() const;
  void set_is_activation_relu(bool value);
 ...
 private:
  ...
  ::xla::ShapeProto* async_out_send_shape_;
...
class HloInputOutputAliasProto :
 ...
 public:
  ...
  static constexpr Kind UNDEFINED_ALIAS =
    HloInputOutputAliasProto_Kind_UNDEFINED_ALIAS;
  static constexpr Kind USER_ALIAS =
    HloInputOutputAliasProto_Kind_USER_ALIAS;
  static constexpr Kind SYSTEM_ALIAS =
  ...
  static inline const std::string& Kind_Name(T enum_t_value) {
    ...
    return HloInputOutputAliasProto_Kind_Name(enum_t_value);
  }
...
// bool is_activation_relu = 73;
inline void HloInstructionProto::clear_is_activation_relu() {
  is_activation_relu_ = false;
}
inline bool HloInstructionProto::is_activation_relu() const {
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.is_activation_relu)
  return is_activation_relu_;
}
inline void HloInstructionProto::set_is_activation_relu(bool value) {
  
  is_activation_relu_ = value;
  // @@protoc_insertion_point(field_set:xla.HloInstructionProto.is_activation_relu)
}

// string rendezvous_key = 1000;
inline void HloInstructionProto::clear_rendezvous_key() {
  rendezvous_key_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline const std::string& HloInstructionProto::rendezvous_key() const {
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.rendezvous_key)
  return rendezvous_key_.Get();
}
inline void HloInstructionProto::set_rendezvous_key(const std::string& value) {
  
  rendezvous_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:xla.HloInstructionProto.rendezvous_key)
}
inline void HloInstructionProto::set_rendezvous_key(std::string&& value) {
  
  rendezvous_key_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:xla.HloInstructionProto.rendezvous_key)
}
inline void HloInstructionProto::set_rendezvous_key(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  rendezvous_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:xla.HloInstructionProto.rendezvous_key)
}
inline void HloInstructionProto::set_rendezvous_key(const char* value,
    size_t size) {
  ...
  rendezvous_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:xla.HloInstructionProto.rendezvous_key)
}
inline std::string* HloInstructionProto::mutable_rendezvous_key() {
  
  // @@protoc_insertion_point(field_mutable:xla.HloInstructionProto.rendezvous_key)
  return rendezvous_key_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* HloInstructionProto::release_rendezvous_key() {
  // @@protoc_insertion_point(field_release:xla.HloInstructionProto.rendezvous_key)
  
  return rendezvous_key_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void HloInstructionProto::set_allocated_rendezvous_key(std::string* rendezvous_key) {
  ...
  rendezvous_key_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), rendezvous_key,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:xla.HloInstructionProto.rendezvous_key)
}
inline std::string* HloInstructionProto::unsafe_arena_release_rendezvous_key() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xla.HloInstructionProto.rendezvous_key)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  
  return rendezvous_key_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void HloInstructionProto::unsafe_arena_set_allocated_rendezvous_key(
    std::string* rendezvous_key) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  if (rendezvous_key != nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.HloInstructionProto.rendezvous_key)
}

// .xla.ShapeProto async_out_send_shape = 1001;
inline bool HloInstructionProto::has_async_out_send_shape() const {
  return this != internal_default_instance() && async_out_send_shape_ != nullptr;
}
inline const ::xla::ShapeProto& HloInstructionProto::async_out_send_shape() const {
  const ::xla::ShapeProto* p = async_out_send_shape_;
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.async_out_send_shape)
  return p != nullptr ? *p : *reinterpret_cast<const ::xla::ShapeProto*>(
      &::xla::_ShapeProto_default_instance_);
}
inline ::xla::ShapeProto* HloInstructionProto::release_async_out_send_shape() {
  // @@protoc_insertion_point(field_release:xla.HloInstructionProto.async_out_send_shape)
  
  ::xla::ShapeProto* temp = async_out_send_shape_;
  if (GetArenaNoVirtual() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  async_out_send_shape_ = nullptr;
  return temp;
}
inline ::xla::ShapeProto* HloInstructionProto::unsafe_arena_release_async_out_send_shape() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xla.HloInstructionProto.async_out_send_shape)
  
  ::xla::ShapeProto* temp = async_out_send_shape_;
  async_out_send_shape_ = nullptr;
  return temp;
}
inline ::xla::ShapeProto* HloInstructionProto::mutable_async_out_send_shape() {
  
  if (async_out_send_shape_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::ShapeProto>(GetArenaNoVirtual());
    async_out_send_shape_ = p;
  }
  // @@protoc_insertion_point(field_mutable:xla.HloInstructionProto.async_out_send_shape)
  return async_out_send_shape_;
}
inline void HloInstructionProto::set_allocated_async_out_send_shape(::xla::ShapeProto* async_out_send_shape) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(async_out_send_shape_);
  }
  if (async_out_send_shape) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(async_out_send_shape)->GetArena();
    if (message_arena != submessage_arena) {
      async_out_send_shape = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, async_out_send_shape, submessage_arena);
    }
  ...
  // @@protoc_insertion_point(field_set_allocated:xla.HloInstructionProto.async_out_send_shape)
}

// bool log = 1002;
inline void HloInstructionProto::clear_log() {
  log_ = false;
}
inline bool HloInstructionProto::log() const {
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.log)
  return log_;
}
inline void HloInstructionProto::set_log(bool value) {
  
  log_ = value;
  // @@protoc_insertion_point(field_set:xla.HloInstructionProto.log)
}
