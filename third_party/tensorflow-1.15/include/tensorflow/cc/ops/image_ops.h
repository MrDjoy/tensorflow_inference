...
/// * `Output` selected_counts
class BatchedNonMaxSuppression {
 public:
  /// Optional attribute setters for BatchedNonMaxSuppression
  struct Attrs {
    /// Defaults to false
  ...
  BatchedNonMaxSuppression(const ::tensorflow::Scope& scope, ::tensorflow::Input
                         boxes, ::tensorflow::Input scores, ::tensorflow::Input
                         box_counts, ::tensorflow::Input max_output_size,
                         ::tensorflow::Input iou_threshold, ::tensorflow::Input
                         score_threshold);
  BatchedNonMaxSuppression(const ::tensorflow::Scope& scope, ::tensorflow::Input
                         boxes, ::tensorflow::Input scores, ::tensorflow::Input
                         box_counts, ::tensorflow::Input max_output_size,
                         ...
                         BatchedNonMaxSuppression::Attrs& attrs);
  ...
  ::tensorflow::Output selected_counts;
};
